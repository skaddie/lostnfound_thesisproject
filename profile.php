 ...
 ?>
    ...
    <div class="card ">
         <div class="card-header">
          <h3>Edit User Profile <span class="float-right"> <a href="index.php" class="btn btn-primary">Back</a> </h3>
        </div>
        <div class="card-body">
     ...
     ?>
          ...
          <form class="" action="" method="POST">
              <div class="form-group">
                ...
                <input type="text" id="inputID" name="inputID" value="<?php echo $getUinfo->inputID; ?>" class="form-control">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <label for="securityquestions">Security Question</label>
                  <select value="<?php echo $getUinfo->securityquestions; ?>" class="text-center form-control" name="securityquestions" style="text-align:left!important; appearance:auto!important;">
                    <option value="" hidden><?php echo $getUinfo->securityquestions; ?></option>
              ...
              <div class="form-group">
                ...
                <input type="securityanswer" name="securityanswer" class="form-control" value="<?php echo $getUinfo->securityanswer; ?>">
              </div>
          ...
          <?php } ?>
              ...
              <div class="form-group">
                ...
                <a class="btn btn-primary" href="changepass.php?id=<?php echo $getUinfo->id;?>">ChangePassword </a>
              </div>
